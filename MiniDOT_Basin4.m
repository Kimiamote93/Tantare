...
textFiles = dir ('C:\MyLake\Donnees_Brutes_20210519\tantare_bassin4_20210519\miniDOT_14m_020463\7450-020463\*.txt')   ; 
numfiles = length(textFiles);
mydata = cell(1, numfiles);

path(path,'C:\MyLake\Donnees_Brutes_20210519\tantare_bassin4_20210519\miniDOT_14m_020463\7450-020463');
...
%Using Missing data function to find the missing data
...
data1 = O_BOTTOM_1 ;
data2 = T_BOTTOM_1 ;
[O_14m_Basin4] =  missingdata(textFiles,date1,date2,data1) ;
[T_14m_Basin4] =  missingdata(textFiles,date1,date2,data2) ;
...
textFiles2 = dir ('C:\MyLake\Donnees_Brutes_20210519\tantare_bassin4_20210519\miniDOT_2m_122660\7450-122660\*.txt')   ; 
numfiles2 = length(textFiles2);
mydata2 = cell(1, numfiles2);

path(path,'C:\MyLake\Donnees_Brutes_20210519\tantare_bassin4_20210519\miniDOT_2m_122660\7450-122660')
...
data3 = O_TOP_1 ;
data4 = T_TOP_1 ;
[O_2m_Basin4] =  missingdata(textFiles2,date1,date2,data3) ;
[T_2m_Basin4] =  missingdata(textFiles2,date1,date2,data4) ;
...
% h_label = ylabel('Oxygen Concentration at Tantare bassin4(mg/l)','visible','on','FontSize',12,'FontName','Times New Roman','FontWeight','bold');
% 
