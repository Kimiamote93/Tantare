...
data1 = PAR_BOTTOM_1 ;
data2 = T_BOTTOM_1 ;
[PAR_10m_Basin4] =  missingdata(textFiles,date1,date2,data1) ;
[T_10m_Basin4] =  missingdata(textFiles,date1,date2,data2) ;

%miniPAR_1m

%Reading all text files in the MiniPAR.

textFiles2 = dir ('C:\MyLake\Donnees_Brutes_20210519\tantare_bassin4_20210519\miniPAR_1m_345582\7530-345582\*.txt')   ; 
numfiles2 = length(textFiles2);
mydata2 = cell(1, numfiles2);

path(path,'C:\MyLake\Donnees_Brutes_20210519\tantare_bassin4_20210519\miniPAR_1m_345582\7530-345582');
...
data3 = PAR_TOP_1 ;
data4 = T_TOP_1 ;
[PAR_1m_Basin4] =  missingdata(textFiles2,date1,date2,data3) ;
[T_1m_Basin4] =  missingdata(textFiles2,date1,date2,data4) ;

 
%the outlier in PAR Bottom

PAR_10m_Basin4 (5,1) =  (PAR_10m_Basin4(4,1) + PAR_10m_Basin4(6,1))/2;
PAR_10m_Basin4 (284,1) =  (PAR_10m_Basin4(283,1) + PAR_10m_Basin4(285,1))/2;
...
h_label = ylabel('Photosynthetically Active Radiation (PAR) at Tantare basin4(umol/(s m^2))','visible','on','FontSize',12,'FontName','Times New Roman','FontWeight','bold');
...
%datenum(xlim)
str = {'(a) PAR at 1m'};
text(737982,270,str,'FontSize',12,'FontName','FixedWidth','FontWeight','bold')
...
str = {'(b) PAR at 10m'};
text(737982,5.5,str,'FontSize',12,'FontName','FixedWidth','FontWeight','bold')
xlabel('Date','FontSize',12,'FontName','Times New Roman','FontWeight','bold')
...
startDate = datenum('07-10-20');                               % X axis                         
endDate = datenum('05-18-21');
xData = linspace(startDate,endDate,313);
% ax = gca;
% ax.XTick = xData;
